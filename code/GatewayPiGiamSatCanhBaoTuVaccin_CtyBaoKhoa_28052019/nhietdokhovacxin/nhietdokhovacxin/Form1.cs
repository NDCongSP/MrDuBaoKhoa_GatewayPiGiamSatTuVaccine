...
namespace nhietdokhovacxin
{
    public partial class Form1 : Form
    {
        ...
        static byte[] canhbao_cao = { 0, 0, 0, 0, 0, 0, 0, 0 };
        static byte[] canhbao_thap = { 0, 0, 0, 0, 0, 0, 0, 0 };
        static byte CanhBaoMatDien = 0;
        static byte[] chot_cao = { 0, 0, 0, 0, 0, 0, 0, 0 };
        static byte[] chot_thap = { 0, 0, 0, 0, 0, 0, 0, 0 };
        static int baocoi = 0;
            ...
            try
            {
                ...
                if (ttkn_server == "GOOD")
                {
                    ...
                    if (dt != null && dt.Rows.Count != 0)
                    {
                        ...
                        label19.Text = TenCB[8] = dt.Rows[8][2].ToString();
                    }
        ...
        private void ghicsdl(Label mylabel1, Label mylabel2, Label mylabel3, Label mylabel4, Label mylabel5, Label mylabel6, Label mylabel7, Label mylabel8, Label mylabel9)
        {
            try
            {
                ...
                ttkn_server = mysql.insert_cmd("xuatbaocao", "now(),'" + TenCB[6] + "','" + Convert.ToDouble(mylabel7.Text).ToString() + "'");
                ttkn_server = mysql.insert_cmd("xuatbaocao", "now(),'" + TenCB[7] + "','" + Convert.ToDouble(mylabel8.Text).ToString() + "'");
                ttkn_server = mysql.insert_cmd("xuatbaocao", "now(),'" + TenCB[8] + "','" + mylabel9.Text + "'");
            }
        ...
        private void BaoMatDien(string TenCB, Label mylabel, string sdtsms, string dcemail)
        {
            try
            {
                ...
                baocoi = canhbao_cao[0] + canhbao_cao[1] + canhbao_cao[2] + canhbao_cao[3] + canhbao_cao[4] + canhbao_cao[5] + canhbao_cao[6] + canhbao_cao[7] +
                    canhbao_thap[0] + canhbao_thap[1] + canhbao_thap[2] + canhbao_thap[3] + canhbao_thap[4] + canhbao_thap[5] + canhbao_thap[6] + canhbao_thap[7] + CanhBaoMatDien;
            ...
            try
            {
                ...
                if (ttkn_server == "GOOD")
                {
                    ...
                    if (dt2 != null && dt2.Rows.Count != 0)
                    {
                        ...
                        BaoMatDien(TenCB[8], label9, dt2.Rows[0][2].ToString(), dt2.Rows[0][4].ToString());
                ...
                ttkn_server = mysql.capnhatgiatriweb(label1.Text.Trim(), label2.Text.Trim(), label3.Text.Trim(), label4.Text.Trim(), label5.Text.Trim(), label6.Text.Trim(), label7.Text.Trim(), label8.Text.Trim(), label9.Text.Trim());
            }
            catch { }
            timer1.Enabled = true;
        }
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                ghicsdl(label1, label2, label3, label4, label5, label6, label7, label8, label9);
            }
            catch { }
            timer2.Enabled = true;
