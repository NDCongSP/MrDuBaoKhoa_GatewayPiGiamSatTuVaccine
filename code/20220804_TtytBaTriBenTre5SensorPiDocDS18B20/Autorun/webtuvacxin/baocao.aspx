                        ...
                        <table style="width: 100%; height: 100%">
                            <tr>
                                ...
                                <td style="width: 15%">
                                    ...
                                    <asp:Button ID="Button1" runat="server" Height="100%" Text="THOÁT" Width="100%" BackColor="#99CCFF" Font-Bold="True" Font-Names="Times New Roman" Font-Size="20pt" Style="color: #FF0000" OnClick="Button1_Click" />
                                        ...
                                        <tr>
                                            <td style="width: 100%; height: 100%">
                                                <table style="width: 100%; border: 2px solid Navy">
                                                    <tr>
                                                        <td style="text-align: center; width: 30%; font-size: x-large; font-weight: 700; border: 2px solid Navy">KHOẢNG THỜI GIAN TỪ:</td>
                                                        ...
                                                        <td style="text-align: center; width: 5%; font-size: x-small; border: 2px solid Navy">
                                                            ...
                                                            <asp:ImageButton ID="ImageButton1" runat="server" Height="35px" ImageUrl="~/calender.jpg" Width="42px" OnClick="ImageButton1_Click" />

                                                        </td>
                                                        <td style="text-align: center; font-size: x-large; font-weight: 700; border: 2px solid Navy">ĐẾN:&nbsp;</td>
                                                        <td style="text-align: center; width: 25%; font-size: x-small; border: 2px solid Navy">
                                                        ...
                                                        <td style="text-align: center; width: 5%; font-size: x-small; border: 2px solid Navy">
                                                            ...
                                                            <asp:ImageButton ID="ImageButton2" runat="server" Height="35px" ImageUrl="~/calender.jpg" Width="42px" OnClick="ImageButton2_Click" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center; width: 30%;">
                                                            ...
                                                            <asp:Button ID="Button6" runat="server" BorderWidth="2pt" Font-Names="Times New Roman" Font-Size="12pt" Style="text-align: center; font-weight: 700" Text="XUẤT BÁO CÁO" Width="60%" BackColor="#FF80FF" OnClick="Button6_Click" />
                                                            <br />
                                                            <br />
                                                        ...
                                                        <td style="text-align: center; width: 25%; font-size: x-small;">
                                                            ...
                                                            <asp:Calendar ID="Calendar1" runat="server" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#663399" Height="221px" ShowGridLines="True" Width="100%" OnSelectionChanged="Calendar1_SelectionChanged">
                                                        ...
                                                        <td style="text-align: center; width: 5%; font-size: x-small">&nbsp;</td>
