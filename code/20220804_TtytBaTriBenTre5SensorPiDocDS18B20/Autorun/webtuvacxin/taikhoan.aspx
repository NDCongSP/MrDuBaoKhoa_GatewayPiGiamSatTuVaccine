                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center; width: 50%">
                                                <table style="text-align: center; width: 100%; border: 5px solid Navy; background-color: LightCyan">
                                                    <tr>
                                                        <td style="text-align: center; border: 2px solid Navy; font-size: 50pt; text-transform: uppercase; color: #FF0000; font-weight: 700;" colspan="2" class="auto-style1">ĐĂNG NHẬP</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align: center; border: 2px solid Navy; width: 50%; font-size: xx-large; font-weight: 700; color: #000000;">TÀI KHOẢN<br />
                                                            ĐĂNG NHẬP</td>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: center; border: 2px solid Navy; width: 50%; font-size: xx-large; font-weight: 700; color: #000000;">MẬT<br />
                                                            &nbsp;KHẨU</td>
