                        ...
                        <table style="width: 100%; height: 100%">
                            <tr>
                                ...
                                <td style="width: 15%">
                                    ...
                                    <asp:Button ID="Button9" runat="server" BackColor="#99CCFF" Font-Bold="True" Font-Names="Times New Roman" Font-Size="20pt" Height="100%" OnClick="Button9_Click" Style="color: #FF0000" Text="RESTART" Width="100%" />
                                                            ...
                                                            <table style="width: 100%; border: 5px solid Navy">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; border: 2px solid Navy" class="auto-style1">
                                                                        ...
                                                                        <asp:Label ID="labCb4" runat="server" Style="font-size: large; font-weight: 700"></asp:Label>

                                                                    </td>
                                                                    <td style="text-align: center; border: 2px solid Navy" class="auto-style1">

                                                                        <asp:TextBox ID="txtIdCb4" runat="server" Height="90%" Width="90%"></asp:TextBox>

                                                                    </td>
                                                                    <td style="text-align: center; border: 2px solid Navy" class="auto-style1">

                                                                        <asp:Button ID="btnCb4" runat="server" Style="font-size: medium" Text="THỰC HIỆN" Width="80%" OnClick="btnCb4_Click" />
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table style="width: 100%; height: 100%; border: 5px solid Navy">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; font-size: x-large; font-weight: 700; border: 2px solid Navy" rowspan="2">ĐẶT MỨC BÁO ĐỘNG</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">NGƯỠNG CAO&nbsp;TỦ </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">NGƯỠNG THẤP TỦ</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
