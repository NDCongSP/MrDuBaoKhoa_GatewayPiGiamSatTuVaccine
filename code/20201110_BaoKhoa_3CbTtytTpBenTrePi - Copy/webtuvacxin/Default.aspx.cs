...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Timer1_Tick(object sender, EventArgs e)
    {
        ...
        try
        {
            MySqlConnection _Con = new MySqlConnection("Server =45.119.212.41 ; Database = ctybaokhoattyttpbentre ; Port=3306;User ID=customer_ttp ;Password=ThinhTamPhat!@#456&*(;charset=utf8");
            _Con.Open();
            ...
            Label6.Text = _dt.Rows[0][3].ToString();
            ...
            hienthi(Label6, _dt.Rows[0][1].ToString(), _dt.Rows[0][0].ToString(),2);
