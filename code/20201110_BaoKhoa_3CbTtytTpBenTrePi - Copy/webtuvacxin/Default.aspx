                            ...
                            <tr>
                                <td>
                                    <table style="width: 100%; height: 100%; background-color: LightCyan">
                                        ...
                                        <tr>
                                            <td style="text-align: center; width: 30%">
                                                <asp:Label ID="Label5" runat="server" Text="Label" Font-Bold="True" Font-Names="Times New Roman" Style="font-size: x-large"></asp:Label>
                                            </td>
                                            <td style="text-align: center; width: 30%">
                                        ...
                                        <tr>
                                            <td style="text-align: center; width: 30%">
                                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                    <ContentTemplate>
                                                        <asp:Label ID="Label6" runat="server" Text="Label" Width="80%" Font-Bold="True" Font-Names="Times New Roman" Style="font-size: 50pt"></asp:Label>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
                                                    </Triggers>
