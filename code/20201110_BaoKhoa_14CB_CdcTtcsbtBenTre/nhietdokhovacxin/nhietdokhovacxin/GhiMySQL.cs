...
namespace nhietdokhovacxin
{
    public class GhiMySQL
    {
        ...
        public string capnhatgiatriweb(string cb1, string cb2, string cb3, string cb4, string cb5, string cb6, string cb7,
            string cb8, string cb9, string cb10, string cb11, string cb12, string cb13, string cb14, string cb15)
        {
            try
            {
                string MysqlCmd = "update hienthiweb set cb1 = '" + cb1 + "',cb2 = '" + cb2 + "',cb3 = '" + cb3 + "',cb4 = '" + cb4 + "',cb5 = '" + cb5 + "',cb6= '"
                    + cb6 + "',cb7 = '" + cb7 + "',cb8 = '" + cb8 + "',cb9 = '" + cb9 + "',cb10 = '" + cb10 + "',cb11 = '" + cb11 + "',cb12 = '" + cb12 + "',cb13 = '" + cb13
                    + "',cb14 = '" + cb14 + "',cb15 = '" + cb15 + "'";
                MySqlCommand cmd = new MySqlCommand(MysqlCmd, connect_local);
                cmd.ExecuteNonQuery();
                cmd.Dispose();
