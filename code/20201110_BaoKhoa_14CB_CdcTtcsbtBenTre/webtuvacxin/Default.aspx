                                    ...
                                    <table style="width: 100%; height: 100%; background-color: LightCyan">
                                        ...
                                        <tr>
                                            <td style="text-align: center; width: 30%">
                                                ...
                                                <asp:Label ID="Label10" runat="server" Text="Label" Font-Bold="True" Font-Names="Times New Roman" Style="font-size: x-large"></asp:Label>

                                            </td>
                                            <td style="text-align: center; width: 30%">

                                                <asp:Label ID="Label20" runat="server" Text="Label" Font-Bold="True" Font-Names="Times New Roman" Style="font-size: x-large"></asp:Label>

                                            </td>
                                            <td style="text-align: center; width: 30%">

                                                <asp:Label ID="Label27" runat="server" Text="Label" Font-Bold="True" Font-Names="Times New Roman" Style="font-size: x-large"></asp:Label>
                                        ...
                                        <tr>
                                            <td style="text-align: center; width: 30%">
                                                <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                                    <ContentTemplate>
                                                        <asp:Label ID="Label22" runat="server" Font-Bold="True" Font-Names="Times New Roman" Style="font-size: 50pt" Text="Label" Width="80%"></asp:Label>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
                                                    </Triggers>
                                            ...
                                            <td style="text-align: center; width: 30%">
                                                <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                                    <ContentTemplate>
                                                        <asp:Label ID="Label23" runat="server" Font-Bold="True" Font-Names="Times New Roman" Style="font-size: 50pt" Text="CB11" Width="80%"></asp:Label>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
                                                    </Triggers>
                                            ...
                                            <td style="text-align: center; width: 30%">
                                                <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                                                    <ContentTemplate>
                                                        <asp:Label ID="Label26" runat="server" Text="CB12" Width="80%" Style="font-size: 50pt" Font-Bold="True" Font-Names="Times New Roman"></asp:Label>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
                                                    </Triggers>
                                        ...
                                        <tr>
                                            <td style="text-align: center; width: 30%">
                                                ...
                                                <asp:Label ID="Label28" runat="server" Text="Label" Font-Bold="True" Font-Names="Times New Roman" Style="font-size: x-large"></asp:Label>

                                            </td>
                                            <td style="text-align: center; width: 30%">

                                                <asp:Label ID="Label29" runat="server" Text="Label" Font-Bold="True" Font-Names="Times New Roman" Style="font-size: x-large"></asp:Label>

                                            </td>
                                            <td style="text-align: center; width: 30%">

                                                <asp:Label ID="Label21" runat="server" Text="Label" Font-Bold="True" Font-Names="Times New Roman" Style="font-size: x-large"></asp:Label>
                                        ...
                                        <tr>
                                            <td style="text-align: center; width: 30%">
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel14" runat="server">
                                                    <ContentTemplate>
                                                        <asp:Label ID="Label30" runat="server" Font-Bold="True" Font-Names="Times New Roman" Style="font-size: 50pt" Text="CB13" Width="80%"></asp:Label>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
                                                    </Triggers>
                                            ...
                                            <td style="text-align: center; width: 30%">
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                                                    <ContentTemplate>
                                                        <asp:Label ID="Label31" runat="server" Font-Bold="True" Font-Names="Times New Roman" Style="font-size: 50pt" Text="CB14" Width="80%"></asp:Label>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
                                                    </Triggers>
                                            ...
                                            <td style="text-align: center; width: 30%">
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                                                    <ContentTemplate>
                                                        <asp:Label ID="Label24" runat="server" Style="font-size: 50pt" Text="Nguon" Width="80%" Font-Names="Times New Roman" Font-Bold="True"></asp:Label>
                                                    </ContentTemplate>
                                                    <Triggers>
                                                        <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
                                                    </Triggers>
