                            ...
                            <tr>
                                ...
                                <td style="width: 15%">
                                 ...
                                 <td style="width: 15%">
                                    ...
                                    <asp:Button ID="Button25" runat="server" BackColor="#99CCFF" Font-Bold="True" Font-Names="Times New Roman" Font-Size="20pt" Height="100%" OnClick="Button25_Click" Style="color: #FF0000" Text="RESTART" Width="100%" />
                                                    ...
                                                    <tr>
                                                        <td style="width: 100%; height: 100%">
                                                            <table style="width: 100%; border: 5px solid Navy">
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; height: 100%; font-size: x-large; border: 2px solid Navy">IDCB</td>
                                                                    <td style="text-align: center; font-size: x-large; width: 25%; height: 100%; border: 2px solid Navy">ĐCID DS18B20</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; font-size: x-large; border: 2px solid Navy">TÊN</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; font-size: x-large; border: 2px solid Navy">THAO TÁC</td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                        ...
                                                                        <asp:Label ID="Label9" runat="server" Style="font-size: large; font-weight: 700"></asp:Label>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:TextBox ID="TextBox9" runat="server" Height="90%" Width="90%"></asp:TextBox>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:TextBox ID="TextBox18" runat="server" Height="90%" Width="90%"></asp:TextBox>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:Button ID="Button14" runat="server" Style="font-size: medium" Text="THỰC HIỆN" Width="80%" OnClick="Button14_Click" />
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                        ...
                                                                        <asp:Label ID="Label11" runat="server" Style="font-size: large; font-weight: 700"></asp:Label>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:TextBox ID="TextBox24" runat="server" Height="90%" Width="90%"></asp:TextBox>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:TextBox ID="TextBox28" runat="server" Height="90%" Width="90%"></asp:TextBox>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:Button ID="Button19" runat="server" Style="font-size: medium" Text="THỰC HIỆN" Width="80%" OnClick="Button19_Click" />
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                        ...
                                                                        <asp:Label ID="Label12" runat="server" Style="font-size: large; font-weight: 700"></asp:Label>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:TextBox ID="TextBox29" runat="server" Height="90%" Width="90%"></asp:TextBox>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:TextBox ID="TextBox31" runat="server" Height="90%" Width="90%"></asp:TextBox>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:Button ID="Button20" runat="server" Style="font-size: medium" Text="THỰC HIỆN" Width="80%" OnClick="Button20_Click" />
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                        ...
                                                                        <asp:Label ID="Label13" runat="server" Style="font-size: large; font-weight: 700"></asp:Label>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <%--<asp:TextBox ID="TextBox34" runat="server" Height="90%" Width="90%"></asp:TextBox>--%>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:TextBox ID="TextBox35" runat="server" Height="90%" Width="90%"></asp:TextBox>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:Button ID="Button22" runat="server" Style="font-size: medium" Text="THỰC HIỆN" Width="80%" OnClick="Button22_Click" />
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                        ...
                                                                        <asp:Label ID="Label14" runat="server" Style="font-size: large; font-weight: 700"></asp:Label>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <%--<asp:TextBox ID="TextBox36" runat="server" Height="90%" Width="90%"></asp:TextBox>--%>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:TextBox ID="TextBox37" runat="server" Height="90%" Width="90%"></asp:TextBox>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:Button ID="Button23" runat="server" Style="font-size: medium" Text="THỰC HIỆN" Width="80%" OnClick="Button23_Click" />
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                        ...
                                                                        <asp:Label ID="Label15" runat="server" Style="font-size: large; font-weight: 700"></asp:Label>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <%--<asp:TextBox ID="TextBox38" runat="server" Height="90%" Width="90%"></asp:TextBox>--%>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:TextBox ID="TextBox39" runat="server" Height="90%" Width="90%"></asp:TextBox>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:Button ID="Button24" runat="server" Style="font-size: medium" Text="THỰC HIỆN" Width="80%" OnClick="Button24_Click" />
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table style="width: 100%; height: 100%; border: 5px solid Navy">
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; font-size: x-large; font-weight: 700; border: 2px solid Navy" rowspan="3">TÀI KHOẢN NGƯỜI<br />
                                                                        DÙNG</td>
                                                                    <td style="text-align: center; font-size: medium; border: 2px solid Navy">NHẬP MẬT KHẨU CŨ</td>
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">NHẬP MẬT KHẨU MỚI</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">NHẬP LẠI MẬT KHẨU MỚI</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; font-weight: 700; font-size: x-large; border: 2px solid Navy" rowspan="2">LƯU DỮ LIỆU</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">THỜI GIAN LƯU DATA(Phút)</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">THỜI GIAN TRỄ CẢNH BÁO(Giây)</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; font-weight: 700; font-size: x-large; border: 2px solid Navy" rowspan="2">CÀI ĐẶT ALARM<br />
                                                                        <span class="auto-style2">(lưu ý các số đt,email cách nhau&nbsp; dấu &quot;,&quot;)</span></td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">CÁC SỐ ĐT NHẬN SMS</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">CÁC EMAIL NHẬN ALARM</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; font-size: x-large; font-weight: 700; border: 2px solid Navy" rowspan="2">ĐẶT MỨC BÁO ĐỘNG TỦ LẠNH</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">NGƯỠNG CAO</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">NGƯỠNG THẤP</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center; width: 25%; font-size: x-large; font-weight: 700; border: 2px solid Navy" rowspan="2">ĐẶT MỨC BÁO ĐỘNG TỦ ÂM</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">NGƯỠNG CAO</td>
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">

                                                                        <asp:TextBox ID="TextBox32" runat="server" Height="90%" Width="90%"></asp:TextBox>

                                                                    </td>
                                                                    <td style="text-align: center; width: 25%; border: 2px solid Navy" rowspan="2">

                                                                        <asp:Button ID="Button21" runat="server" Style="font-size: medium" Text="THỰC HIỆN" Width="80%" OnClick="Button21_Click" />
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: center; width: 25%; height: 100%; border: 2px solid Navy">
                                                                        ...
                                                                        <asp:TextBox ID="TextBox33" runat="server" Height="90%" Width="90%"></asp:TextBox>
