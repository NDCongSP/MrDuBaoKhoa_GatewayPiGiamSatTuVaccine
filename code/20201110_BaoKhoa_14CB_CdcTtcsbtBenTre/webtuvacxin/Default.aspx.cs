    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["Khoa"] == "Mo")
        {
            if (!IsPostBack)
            {
                ...
                Label18.Text = dt.Rows[7][2].ToString();
                Label19.Text = dt.Rows[8][2].ToString();
                Label10.Text = dt.Rows[9][2].ToString();
                Label20.Text = dt.Rows[10][2].ToString();

                Label27.Text = dt.Rows[11][2].ToString();
                Label28.Text = dt.Rows[12][2].ToString();
                Label29.Text = dt.Rows[13][2].ToString();

                Label21.Text = dt.Rows[14][2].ToString();
            }
        }
        else
        {
       ...
       // try
        {
            ...
            Label8.Text = _dt.Rows[0][7].ToString();
            Label9.Text = _dt.Rows[0][8].ToString();
            Label22.Text = _dt.Rows[0][9].ToString();
            Label23.Text = _dt.Rows[0][10].ToString();

            Label26.Text = _dt.Rows[0][11].ToString();
            Label30.Text = _dt.Rows[0][12].ToString();
            Label31.Text = _dt.Rows[0][13].ToString();

            Label24.Text = _dt.Rows[0][14].ToString();
            ...
            _dt = new DataTable();
            _da.Fill(_dt);
            hienthi(Label1, _dt.Rows[0][6].ToString(), _dt.Rows[0][5].ToString(), 0);
            ...
            hienthi(Label7, _dt.Rows[0][1].ToString(), _dt.Rows[0][0].ToString(), 6);
            hienthi(Label8, _dt.Rows[0][1].ToString(), _dt.Rows[0][0].ToString(), 7);
            hienthi(Label9, _dt.Rows[0][1].ToString(), _dt.Rows[0][0].ToString(), 8);
            hienthi(Label22, _dt.Rows[0][1].ToString(), _dt.Rows[0][0].ToString(), 9);
            hienthi(Label23, _dt.Rows[0][1].ToString(), _dt.Rows[0][0].ToString(), 10);

            hienthi(Label26, _dt.Rows[0][1].ToString(), _dt.Rows[0][0].ToString(), 11);
            hienthi(Label30, _dt.Rows[0][1].ToString(), _dt.Rows[0][0].ToString(), 12);
            hienthi(Label31, _dt.Rows[0][1].ToString(), _dt.Rows[0][0].ToString(), 13);
