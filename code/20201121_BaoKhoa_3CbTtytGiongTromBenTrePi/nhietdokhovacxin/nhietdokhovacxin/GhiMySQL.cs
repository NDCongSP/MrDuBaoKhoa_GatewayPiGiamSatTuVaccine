...
namespace nhietdokhovacxin
{
    ...
    {
        public string ChuoiKetnoiMySQL_local = "Server =45.119.212.41 ; Database = ctybaokhoattytgiongtrombentre ; Port=3306;User ID=customer_ttp ;Password=ThinhTamPhat!@#456&*(;charset=utf8";
