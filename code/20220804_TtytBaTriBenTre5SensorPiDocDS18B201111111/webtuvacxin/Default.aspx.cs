...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["Khoa"] == "Mo")
        {
            if (!IsPostBack)
            {
                ...
                Con = new MySqlConnection("Server =45.119.212.41 ; Database = ctybaokhoattytbatribentre ; Port=3306;User ID=customer_ttp ;Password=ThinhTamPhat!@#456&*(;charset=utf8");
                Con.Open();
    ...
    protected void Timer1_Tick(object sender, EventArgs e)
    {
        ...
        try
        {
            MySqlConnection _Con = new MySqlConnection("Server =45.119.212.41 ; Database = ctybaokhoattytbatribentre ; Port=3306;User ID=customer_ttp ;Password=ThinhTamPhat!@#456&*(;charset=utf8");
            _Con.Open();
