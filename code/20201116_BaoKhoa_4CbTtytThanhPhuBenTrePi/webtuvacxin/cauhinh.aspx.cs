...
public partial class cauhinh : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["Khoa"] == "Mo")
        {
            if (!IsPostBack)
            {
                ...
                //    TextBox1.Text = dt.Rows[3][2].ToString();
                //}
                //dt.Clear();
                ...
                //CHINH CHO NAY
                //string[] lines = System.IO.File.ReadAllLines(@"D:\ATPro\CodeProject\GatewayPi\TTYTBaoKhoa\20201116_BaoKhoa_4CbTtytThanhPhuBenTrePi\nhietdokhovacxin\nhietdokhovacxin\bin\Debug\Files\idds18b20.txt");
    ...
    private void capnhatid(TextBox mytextbox2, Label mylabel)
    {
        try
        {
            ...
            WriteText(data, "/home/pi/Filesidds18b20.txt");
            ...
            Con.Open();
            data = "update idds18b20 set tencb='" + mytextbox2.Text + "' where id='" + mylabel.Text.Trim() + "'";
    ...
    protected void Button6_Click(object sender, EventArgs e)
    {
        ...
        //string data= Label1.Text+"|"+TextBox10.Text+"\n"+ Label2.Text + "|" + TextBox11.Text + "\n" 
        //    + Label3.Text + "|" + TextBox12.Text + "\n"++ Label4.Text + "|" + TextBox1.Text;
        //WriteText(TextBox26.Text.Trim() + "|" + TextBox27.Text.Trim() + "|" + TextBox22.Text.Trim() + "|" + TextBox30.Text.Trim(), "/home/pi/GioiHanNhietDo.txt");
    }
    ...
    protected void Button16_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            WriteText(TextBox22.Text.Trim() + "|" + TextBox30.Text.Trim(), "/home/pi/Files/ThoiGianCapNhat.txt");
            //WriteText(TextBox22.Text.Trim() + "|" + TextBox30.Text.Trim(), @"D:\ATPro\CodeProject\GatewayPi\TTYTBaoKhoa\20201116_BaoKhoa_4CbTtytThanhPhuBenTrePi\nhietdokhovacxin\nhietdokhovacxin\bin\Debug\Files\ThoiGianCapNhat.txt");
    ...
    protected void Button17_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            WriteText(TextBox26.Text.Trim() + "|" + TextBox27.Text.Trim() + "|" + TextBox23.Text.Trim() + "|" + TextBox25.Text.Trim(), "/home/pi/Files/GioiHanNhietDo.txt");
