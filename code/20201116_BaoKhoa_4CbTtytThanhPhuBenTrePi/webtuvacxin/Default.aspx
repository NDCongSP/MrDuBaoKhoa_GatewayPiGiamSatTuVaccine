                             ...
                             <tr>
                              ...
                              <tr>
                                 <td style="text-align:center ; width:30%">
                                             ...
                                             <asp:Label ID="Label26" runat="server" Text="Label"  Font-Bold="True" Font-Names="Times New Roman" style="font-size: x-large"></asp:Label>
                              ...
                              <tr>
                                 <td style="text-align:center ; width:30%">
                                     ...
                                     <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                         <ContentTemplate>
                                             <asp:Label ID="Label27" runat="server" Font-Bold="True" Font-Names="Times New Roman" style="font-size: 50pt" Text="Label" Width="80%"></asp:Label>
                                         </ContentTemplate>
                                         <Triggers>
                                             <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
                                         </Triggers>
