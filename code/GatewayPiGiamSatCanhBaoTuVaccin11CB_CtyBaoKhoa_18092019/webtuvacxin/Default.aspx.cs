...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["Khoa"] == "Mo")
        {
            if (!IsPostBack)
            {
                ...
                Con = new MySqlConnection("Server = 103.48.195.37 ; Database = ctybaokhoattytbentre ; Port=3306;User ID=plcpi_giamsat ;Password=12345;charset=utf8");
                Con.Open();
                ...
                Label21.Text = dt.Rows[11][2].ToString();
            }
        }
        else
        {
    ...
    protected void Timer1_Tick(object sender, EventArgs e)
    {
        ...
        try
        {
            MySqlConnection _Con = new MySqlConnection("Server = 103.48.195.37 ; Database = ctybaokhoattytbentre ; Port=3306;User ID=plcpi_giamsat ;Password=12345;charset=utf8");
            _Con.Open();
            ...
            Label24.Text = _dt.Rows[0][11].ToString();
