                              ...
                              <tr>
                                 <td style="text-align:center ; width:30%">
                                     ...
                                     <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                         <ContentTemplate>
                                             <asp:Label ID="Label22" runat="server" Text="Label" Width="80%" Font-Names="Times New Roman" style="font-size: 50pt" Font-Bold="True"></asp:Label>
                                         </ContentTemplate>
                                         <Triggers>
                                             <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
                                         </Triggers>
                                 ...
                                 <td style="text-align:center ; width:30%">
                                     ...
                                     <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                         <ContentTemplate>
                                             <asp:Label ID="Label23" runat="server" Text="Label" Width="80%" style="font-size:50pt" Font-Bold="True" Font-Names="Times New Roman"></asp:Label>
                                         </ContentTemplate>
                                         <Triggers>
                                             <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
                                         </Triggers>
                                 ...
                                 <td style="text-align:center ; width:30%">
                                     ...
                                     <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                                         <ContentTemplate>
                                             <asp:Label ID="Label24" runat="server" style="font-size: 50pt" Text="Label" Width="80%" Font-Names="Times New Roman" Font-Bold="True"></asp:Label>
                                         </ContentTemplate>
                                         <Triggers>
                                             <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="Tick" />
                                         </Triggers>
